...
public class PhantomJsWorker extends Thread
{
    ...
    public void initializePhantom()
    {
        ...
        ((DesiredCapabilities) caps).setCapability(
                ...
                phantomJsManager.getPhantomJsPath()
        );
        ...
        driver.manage().timeouts().pageLoadTimeout(phantomJsManager.getJsTimeOut(), TimeUnit.SECONDS);
        driver.manage().timeouts().setScriptTimeout(phantomJsManager.getJsTimeOut(), TimeUnit.SECONDS);
